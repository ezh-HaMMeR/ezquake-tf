...
macro(check_dependency target_var pkg_config_name vcpkg_name vcpkg_target_name)
    ...
    if (USE_SYSTEM_LIBS)
        ...
        if (${target_var}_FOUND)
            if ("${target_var}" STREQUAL "MiniZip")
                find_path(MINIZIP_COMPAT_INCLUDE_DIR unzip.h PATH_SUFFIXES minizip REQUIRED)
                target_include_directories(PkgConfig::${target_var} INTERFACE "${MINIZIP_COMPAT_INCLUDE_DIR}")
            endif()
        ...
        get_target_property(_ALIASED_TARGET ${vcpkg_target_name} ALIASED_TARGET)
        if (_ALIASED_TARGET)
            add_library(Dep::${target_var} ALIAS ${_ALIASED_TARGET})
        else()
